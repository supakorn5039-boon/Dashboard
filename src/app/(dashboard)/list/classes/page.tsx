...
import { classesData, columns } from "@/data/Classes";

import { role } from "@/data/Role";
import { ClassesType } from "@/types/ClassesType";

import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function ClassestList() {
  const renderRow = (item: ClassesType) => (
    <tr
      key={item.id}
