...
import { subjectsData, columns } from "@/data/Subject";
import { SucjectType } from "@/types/SubjectType";

import Image from "next/image";
import Link from "next/link";
import React from "react";

export default function SubjecttList() {
  const renderRow = (item: SucjectType) => (
    <tr
      key={item.id}
